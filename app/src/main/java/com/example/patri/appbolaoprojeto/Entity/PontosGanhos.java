 ...
 */
public class PontosGanhos extends SugarRecord implements Serializable {

    public PontosGanhos(Integer qtMandante, Integer qtTotal, Integer qtVisitante) {
        this.qtMandante = qtMandante;
        this.qtTotal = qtTotal;
        this.qtVisitante = qtVisitante;
    }

    public PontosGanhos(String cdEquipe, Integer qtMandante, Integer qtTotal, Integer qtVisitante) {
