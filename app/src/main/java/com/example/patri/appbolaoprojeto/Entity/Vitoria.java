 ...
 */
public class Vitoria extends SugarRecord implements Serializable {

    public Vitoria(Integer qtMandante, Integer qtTotal, Integer qtVisitante) {
        this.qtMandante = qtMandante;
        this.qtTotal = qtTotal;
        this.qtVisitante = qtVisitante;
    }

    public Vitoria(String cdEquipe, Integer qtMandante, Integer qtTotal, Integer qtVisitante) {
