 ...
 */
public class Jogos extends SugarRecord implements Serializable {
    public Jogos(Integer qtMandante, Integer qtTotal, Integer qtVisitante) {
        this.qtMandante = qtMandante;
        this.qtTotal = qtTotal;
        this.qtVisitante = qtVisitante;
    }

    public Jogos(String cdEquipe, Integer qtMandante, Integer qtTotal, Integer qtVisitante) {
